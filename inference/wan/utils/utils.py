...
def save_video(tensor,
    ...
    try:
        ...
        # write video using imageio (bundled imageio-ffmpeg binary; no system
        # ffmpeg on the compute nodes, which mediapy would require)
...
def masks_like_batch(tensor, zero=True):
